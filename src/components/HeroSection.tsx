...
const HeroSection = () => {
  ...
  return (
    <section className="relative h-[90vh] w-full flex items-center justify-center text-white">
      {/* Full-width, full-height background image with overlay gradient */}
      <div className="absolute inset-0 w-full h-full">
        ...
        />
        <div className="absolute inset-0 bg-gradient-to-t from-mindful3-darker/70 to-transparent"></div>
      </div>
      
      <div className="container-custom text-center relative z-10">
        <h1 className="text-5xl md:text-7xl font-bold mb-6 leading-tight font-raleway">
          FIND YOUR <span className="text-mindful2 nike-highlight">INNER PEACE</span>
        </h1>
        ...
        <Button 
          className="button-primary bg-mindful text-white px-8 py-6 rounded-full text-lg transform transition-transform hover:scale-105 hover:shadow-xl"
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
          <div className="bg-gray-900 p-6 rounded-xl shadow-2xl max-w-md w-full animate-float-up border border-mindful/20">
            ...
            <div className="bg-gray-800 rounded-lg p-4 mb-4 shadow-inner">
              ...
              <p className="text-center mt-4 text-gray-300 font-sans">
